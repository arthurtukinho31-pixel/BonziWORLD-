...
function loadBonzis(a) {
    loadQueue.loadManifest([
        ...
        { id: "bonziQuartz", src: "./img/bonzi/quartz.png" },
        { id: "bonziNethergold", src: "./img/bonzi/nethergold.png" },
        { id: "bonziPurplesaber", src: "./img/bonzi/purplesaber.png" },
        { id: "bonziCameraman", src: "./img/bonzi/cameraman.png" },
        { id: "bonziCartoonnetwork", src: "./img/bonzi/cartoonnetwork.png" },
        { id: "bonziBrasilempire", src: "./img/bonzi/brasilempire.png" },
        { id: "bonziStella", src: "./img/bonzi/stella.png" },
        { id: "bonziGrinnyboi", src: "./img/bonzi/grinnyboi.png" },
        { id: "bonziYan", src: "./img/bonzi/yan.png" },
        { id: "bonziPeedy", src: "./img/bonzi/peedy.png" },
        { id: "bonziBustystickwoman", src: "./img/bonzi/bustystickwoman.png" },
...
function errorFatal() {
    ("none" != $("#page_ban").css("display") && "none" != $("#page_kick").css("display")) || $("#page_error").show();
      ...
      function setup() {
        ...
        socket.on("poll", function (a) {
            window.polls[a.id] = { id: a.id, title: a.title, options: a.options, votes: [] };
            var b = bonzis[a.guid];
            if (b) b.showPoll(a.id, a.title, a.options);
        }),
        socket.on("vote", function (a) {
            updatePoll(a.poll, a.vote, a.guid, a.counts);
        }),
        ...
        socket.on("nuke", function (data) {
            let bonzi = bonzis[data.guid];
            if (bonzi) bonzi.explode();
        }),
...
window.polls = {};
window.pollElements = {};
function createPoll(a, b) {
    b = b || {};
    var c = document.createElement("div");
    c.className = "poll";
    c.dataset.pollId = a.id;
    var d = document.createElement("div");
    d.className = "poll_title";
    d.textContent = a.title;
    c.appendChild(d);
    var e = document.createElement("div");
    e.className = "poll_options";
    a.options.forEach(function (a) {
        var d = document.createElement("button");
        d.type = "button";
        d.className = "poll_option";
        d.textContent = a;
        d.onclick = function () {
            socket.emit("vote", { poll: c.dataset.pollId, vote: a });
            if (typeof b.onvote === "function") b.onvote.call(c);
        };
        e.appendChild(d);
    });
    c.appendChild(e);
    var f = document.createElement("div");
    f.className = "poll_results";
    c.appendChild(f);
    c.setPoll = function (a) {
        var b = {};
        a.options.forEach(function (a) {
            b[a] = 0;
        });
        if (a.counts) {
            Object.keys(a.counts).forEach(function (c) {
                if (typeof b[c] != "undefined") b[c] = a.counts[c];
            });
        } else {
            (a.votes || []).forEach(function (a) {
                if (typeof b[a.vote] != "undefined") b[a.vote]++;
            });
        }
        f.innerHTML = "";
        a.options.forEach(function (a) {
            var d = document.createElement("div");
            d.className = "poll_result";
            d.textContent = a + ": " + b[a];
            f.appendChild(d);
        });
    };
    window.pollElements[a.id] = c;
    c.setPoll(a);
    return c;
}
function updatePoll(a, b, c, d) {
    if (!window.polls[a]) return;
    var e = window.polls[a];
    e.votes = e.votes || [];
    if (d && typeof d == "object") {
        e.counts = d;
    } else {
        var f = e.votes.find(function (a) {
            return a.guid === c;
        });
        if (f) f.vote = b;
        else e.votes.push({ guid: c, vote: b });
    }
    if (window.pollElements[a]) window.pollElements[a].setPoll(e);
}
    ...
    Bonzi = (function () {
        function a(b, c) {
            ...
            _classCallCheck(this, a),
                ...
                this.colorPrev,
                this.hatPrev,
                (this.hat = this.userPublic.hat || null),
                ...
                (this.run = !0),
                (this.mute = !1),
                (this.eventTypeToFunc = { anim: "updateAnim", html: "updateText", text: "updateText", idle: "updateIdle", add_random: "updateRandom", poll: "updatePoll" }),
            ...
            _createClass(a, [
                ...
                },
                {
                    ...
                    value: function (a, b) {
                        ...
                        (this.x = Math.min(Math.max(0, this.x), c.x)),
                            ...
                            this.hatBitmap && ((this.hatBitmap.x = this.x + 75), (this.hatBitmap.y = this.y + 20)),
                ...
                },
              {
                ...
                },
                {
                    key: "updatePoll",
                    value: function () {
                        var a = this.event.cur();
                        if (this.currentPollId !== a.id) {
                            this.currentPollId = a.id;
                            this.showPoll(a.id, a.text, a.options);
                        }
                    },
                },
                {
                ...
                },
                {
                    ...
                    value: function (a, b, c) {
                        this.runSingleEvent([{ type: "poll", id: a, text: b, options: c || ["Yes", "No"] }]);
                    },
                },
                {
                    key: "showPoll",
                    value: function (a, b, c) {
                        ...
                        var e = createPoll(d, {
                            onvote: function () {
                                if (this.pollElement) {
                                    this.pollElement.classList.add("poll_voted");
                                }
                                f.clearDialog();
                                f.eventNext();
                                f.currentPollId = null;
                            },
                        });
                        this.$dialogCont.text("").append(e), this.$dialog.show();
                    },
                },
                {
                    key: "update",
                ...
                },
                {
                    key: "deconstruct",
                    value: function () {
                        this.stopSpeaking(), BonziHandler.stage.removeChild(this.sprite), this.hatBitmap && BonziHandler.stage.removeChild(this.hatBitmap), (this.run = !1), this.$element.remove();
                    },
                },
                {
                    key: "updateName",
                ...
                },
                {
                    ...
                    value: function (a) {
                        ...
                        if (this.colorPrev != this.color) {
                            if (this.sprite) b.removeChild(this.sprite);
                            delete this.sprite;
                            (function(c) {
                                if (BonziHandler.spriteSheets[c]) {
                                    this.sprite = new createjs.Sprite(BonziHandler.spriteSheets[c], a ? "gone" : "idle");
                                } else {
                                    var images = c.startsWith('http') ? [c] : ["./img/bonzi/purple.png"];
                                    var d = { images: images, frames: BonziData.sprite.frames, animations: BonziData.sprite.animations };
                                    var ss = new createjs.SpriteSheet(d);
                                    this.sprite = new createjs.Sprite(ss, a ? "gone" : "idle");
                                    if (c.match(/^#[0-9a-fA-F]{6}$/)) {
                                        ...
                                        this.sprite.filters = [new createjs.ColorFilter(r, g, b, 1, 0, 0, 0, 0)];
                                        this.sprite.cache(0,0,200,160);
                                    }
                                }
                            }.call(this, this.color));
                            this.colorPrev = this.color;
                            b.addChild(this.sprite);
                        }
                        if (this.hatPrev != this.hat) {
                            if (this.hatBitmap) b.removeChild(this.hatBitmap);
                            if (this.hat && BonziHandler.hatImages[this.hat] && BonziHandler.hatImages[this.hat].complete) {
                                this.hatBitmap = new createjs.Bitmap(BonziHandler.hatImages[this.hat]);
                                this.hatBitmap.x = this.x + 75;
                                this.hatBitmap.y = this.y + 20;
                                b.addChild(this.hatBitmap);
                            }
                            this.hatPrev = this.hat;
                        }
                        this.move();
                    },
                },
                    ...
                    value: function () {
                        ...
                        var interval = setInterval(function () {
                            ...
                            if (el) {
                                ...
                                el.style.marginLeft = this.x + "px";
                                el.style.marginTop = this.y + "px";
                            }
                            if (this.sprite) {
                                this.sprite.x = this.x;
                                this.sprite.y = this.y;
        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["aqua", "black", "blue", "brown", "cyan", "diamond", "emerald", "god", "gold", "green", "lime", "orange", "pink", "purple", "red", "white", "yellow","quartz", "nethergold","purplesaber","pope","blessed","cameraman","cartoonnetwork","brasilempire","stella","grinnyboi","yan","peedy" ,"bustystickwoman" ], b = 0; b < a.length; b++) {
                        var c = a[b],
                            ext = "png";
                        if ("blessed" === c) ext = "webp";
                        var d = { images: ["./img/bonzi/" + c + "." + ext], frames: BonziData.sprite.frames, animations: BonziData.sprite.animations };
                        this.spriteSheets[c] = new createjs.SpriteSheet(d);
                    }
                }),
                (this.loadHats = function () {
                    var a = { witch: "https://files.catbox.moe/9xw19z.webp", chain: "https://files.catbox.moe/me46mf.webp", cigar: "https://files.catbox.moe/k9ez0y.webp", obama: "https://files.catbox.moe/387att.webp" };
                    for (var b in a) {
                        var c = new Image();
                ...
                (this.bonzisCheck = function () {
                    for (var a = 0; a < usersAmt; a++) {
                        ...
                        if (b in bonzis) {
                            ...
                            var e = usersPublic[b].hat;
                            c.hat != e && ((c.hat = e), c.updateSprite());
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziAqua", "bonziBlack", "bonziBlue", "bonziBrown", "bonziCyan", "bonziDiamond", "bonziEmerald", "bonziGold", "bonziGreen", "bonziLime", "bonziOrange", "bonziPink", "bonziPurple", "bonziRed", "bonziPink", "bonziWhite", "bonziYellow",  "bonziPurplesaber" ,"bonziNethergold","bonziQuartz"  ,"bonziCartoonnetwork", "bonziBrasilempire","bonziStella","bonziGrinnyboi","bonziYan",  "bonziPeedy",  "bonziBustystickwoman",  "topjej"];
